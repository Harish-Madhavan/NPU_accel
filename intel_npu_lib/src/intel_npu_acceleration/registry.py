...
_SUPPORTED_MODULES = {
    ...
    torch.nn.Hardsigmoid, torch.nn.Hardswish,
...
class OpRegistry:
    ...
    @classmethod
    def get_function(cls, target) -> Optional[bool]:
        return True if target in cls._functions else None

    @classmethod
    def get_method(cls, name: str) -> Optional[bool]:
        return True if name in cls._methods else None

    @classmethod
    def get_module(cls, module_type) -> Optional[bool]:
        return True if module_type in cls._modules else None
